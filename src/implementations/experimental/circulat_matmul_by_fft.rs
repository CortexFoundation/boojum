...
#[inline(always)]
#[unroll_for_loops]
pub fn goldilocks_mds_matmul_by_fft(state: &mut [GoldilocksField; 12]) {
    ...
    for r in 0..12 {
        ...
        // original code would have a manual reduction here, but we already have a method for it
...
#[inline(never)]
pub fn goldilocks_mds_matmul_by_fft_ext(state: &mut [GoldilocksField; 12]) {
    goldilocks_mds_matmul_by_fft(state);
}
